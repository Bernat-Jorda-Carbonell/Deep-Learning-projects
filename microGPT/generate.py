...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_weights_folder', type=str, default='./logs/gpt-mini/version_12/checkpoints')
    parser.add_argument('--num_samples', type=int, default=10)
    parser.add_argument('--num_generated_tokens', type=int, default=250)
    parser.add_argument('--do_sample', type=bool, default=True)
    parser.add_argument('--temperature', type=float, default=1.0)
    parser.add_argument('--top_k', type=int, default=None)
    parser.add_argument("--top_p", type=float, default=0.6)
    parser.add_argument('--prompt', type=str, default='The chicken crossed the road because')
